...
def density_tab(flights):
	...
	def make_dataset(carrier_list, range_start, range_end, bandwidth):
		...
		for i, carrier in enumerate(carrier_list):
			...
			subset = subset[subset['Overall Rating'].between(range_start, 
														range_end)]
	...
	def make_plot(src):
		p = figure(plot_width = 700, plot_height = 700,
				   ...
				   x_axis_label = 'Overall Rating', y_axis_label = 'Density')
	...
	controls = WidgetBox(range_select, 
						 bandwidth_select, bandwidth_choose, carrier_selection)
